...
// Contains samples of sine waves for all notes${PERIODS === 0? '' : ` (${PERIODS} periods minimum)`}, octaves ${OCTAVES[0]}-${OCTAVES[1]}, mapped from [0, 1] => [0, 255], at a sample rate of ${SAMPLE_RATE} Hz.
//
